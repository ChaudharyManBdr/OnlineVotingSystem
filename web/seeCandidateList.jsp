<%-- 
    Document   : seeCandidateList
    Created on : Aug 7, 2014, 6:39:01 PM
    Author     : Manav
--%>
    ...
    <body>
        ...
        <div class="wrapper"> 
         ...
         <div class="form_registration">
                ...
                <table width="965" height="50" border="1">
                    <tr>
