...
public class UserAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String roleAs = request.getParameter("role");
        ...
        if (passWord.equals(passWord2)) {
            ...
            mua.setRole(roleAs);
            mua.setName(Name);
            mua.setAddress(Address);
            mua.setEmail(Email);
            mua.setPhone(Phone);
            mua.setUsername(userName);
            mua.setPassword(passWord);
            boolean Y = mua.createAccount();

            String success = "Successfully  New User Is Created !";
            String failed = "Sorry  Failed";
            if (Y) {
            ...
            RequestDispatcher view = request.getRequestDispatcher("createUserAccount.jsp");
