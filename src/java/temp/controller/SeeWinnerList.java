 ...
 * @author Manav
 */
@WebServlet(name = "SeeWinnerList", urlPatterns = {"/SeeWinnerList"})
public class SeeWinnerList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (list != null) {
            ...
            RequestDispatcher view = request.getRequestDispatcher("seeWinnerList.jsp");
            view.forward(request, response);
        } else {
            request.setAttribute("Message", "Error : Sorry Failed !");
            RequestDispatcher view = request.getRequestDispatcher("messageError.jsp");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SeeWinnerList</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SeeWinnerList at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
