 ...
 * @author Manav
 */
@WebServlet(name = "PendingListShow", urlPatterns = {"/PendingListShow"})
public class PendingListShow extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        pv.setVdc(vdcName);
         ...
         ArrayList<PendingVoting> list = pv.showPendinglist();
        if(list!=null){      
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PendingListShow</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PendingListShow at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
