 ...
 * @author Manav
 */
@WebServlet(name = "SeeResult", urlPatterns = {"/SeeResult"})
public class SeeResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (list != null) {
            ...
            RequestDispatcher view = request.getRequestDispatcher("seeResult.jsp");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SeeResult</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SeeResult at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
