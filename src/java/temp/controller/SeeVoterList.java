...
import temp.model.PendingVoting;

/**
 *
 * @author Manav
 */
@WebServlet(name = "SeeVoterList", urlPatterns = {"/SeeVoterList"})
public class SeeVoterList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<PendingVoting> list = pv.seeVoterlist();
        if(list!=null){      
        request.setAttribute("value", list);
        RequestDispatcher view = request.getRequestDispatcher("seeVoterList.jsp");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SeeVoterList</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SeeVoterList at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
